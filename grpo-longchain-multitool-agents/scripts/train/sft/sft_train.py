...
def main():
    ...
    if use_swanlab:
        ...
        swanlab_cb = SwanLabCallback(
            project=logger_cfg.get("project", "grpo-longchain-multitool-agents"),
        ...
        print(f"[logger] swanlab enabled, project={logger_cfg.get('project', 'grpo-longchain-multitool-agents')}")
    else:
